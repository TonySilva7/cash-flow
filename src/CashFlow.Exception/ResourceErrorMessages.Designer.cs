...
namespace CashFlow.Exception
{
    ...
    public class ResourceErrorMessages
    {
        ...
        /// </summary>
        public static string AMOUNT_MUT_BE_GREATER_THAN_ZERO
        {
            get
            {
                return ResourceManager.GetString("AMOUNT_MUT_BE_GREATER_THAN_ZERO", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string PAEMNT_TYPE_INVALID
        {
            get
            {
                return ResourceManager.GetString("PAEMNT_TYPE_INVALID", resourceCulture);
            }
        }
